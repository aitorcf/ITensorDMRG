...
spectrum_matrix = diagm(readdlm("triangulene/States.txt",Float64)[:,3])
ITensors.op(::OpName"Spectrum",::SiteType"Triangulene") = spectrum_matrix

cdagup1_matrix = readdlm("triangulene/Creation_op_up_1.txt",Float64)
...
cdagdn1_matrix = readdlm("triangulene/Creation_op_down_1.txt",Float64)
...
cdagup2_matrix = readdlm("triangulene/Creation_op_up_2.txt",Float64)
...
cdagdn2_matrix = readdlm("triangulene/Creation_op_down_2.txt",Float64)
...
cdagup3_matrix = readdlm("triangulene/Creation_op_up_3.txt",Float64)
...
cdagdn3_matrix = readdlm("triangulene/Creation_op_down_3.txt",Float64)
...
cdagup4_matrix = readdlm("triangulene/Creation_op_up_4.txt",Float64)
...
cdagdn4_matrix = readdlm("triangulene/Creation_op_down_4.txt",Float64)
